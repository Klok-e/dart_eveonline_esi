...
class GetCharactersCharacterIdWalletJournal200Ok {
  ...
  @override
  String toString() {
    return 'GetCharactersCharacterIdWalletJournal200Ok[amount=$amount, balance=$balance, contextId=$contextId, contextIdType=$contextIdType, date=$date, description=$description, firstPartyId=$firstPartyId, id=$id, reason=$reason, refType=$refType, secondPartyId=$secondPartyId, tax=$tax, taxReceiverId=$taxReceiverId, ]';
  }

  GetCharactersCharacterIdWalletJournal200Ok.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<GetCharactersCharacterIdWalletJournal200Ok> listFromJson(List<dynamic> json) {
    return json == null ? List<GetCharactersCharacterIdWalletJournal200Ok>() : json.map((value) => GetCharactersCharacterIdWalletJournal200Ok.fromJson(value)).toList();
  }

  static Map<String, GetCharactersCharacterIdWalletJournal200Ok> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GetCharactersCharacterIdWalletJournal200Ok>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GetCharactersCharacterIdWalletJournal200Ok.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetCharactersCharacterIdWalletJournal200Ok-objects as value to a dart map
  static Map<String, List<GetCharactersCharacterIdWalletJournal200Ok>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<GetCharactersCharacterIdWalletJournal200Ok>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = GetCharactersCharacterIdWalletJournal200Ok.listFromJson(value);
       });
     }
     return map;
  }
