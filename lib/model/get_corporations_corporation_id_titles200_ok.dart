...
class GetCorporationsCorporationIdTitles200Ok {
  ...
  @override
  String toString() {
    return 'GetCorporationsCorporationIdTitles200Ok[grantableRoles=$grantableRoles, grantableRolesAtBase=$grantableRolesAtBase, grantableRolesAtHq=$grantableRolesAtHq, grantableRolesAtOther=$grantableRolesAtOther, name=$name, roles=$roles, rolesAtBase=$rolesAtBase, rolesAtHq=$rolesAtHq, rolesAtOther=$rolesAtOther, titleId=$titleId, ]';
  }

  GetCorporationsCorporationIdTitles200Ok.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<GetCorporationsCorporationIdTitles200Ok> listFromJson(List<dynamic> json) {
    return json == null ? List<GetCorporationsCorporationIdTitles200Ok>() : json.map((value) => GetCorporationsCorporationIdTitles200Ok.fromJson(value)).toList();
  }

  static Map<String, GetCorporationsCorporationIdTitles200Ok> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GetCorporationsCorporationIdTitles200Ok>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GetCorporationsCorporationIdTitles200Ok.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetCorporationsCorporationIdTitles200Ok-objects as value to a dart map
  static Map<String, List<GetCorporationsCorporationIdTitles200Ok>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<GetCorporationsCorporationIdTitles200Ok>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = GetCorporationsCorporationIdTitles200Ok.listFromJson(value);
       });
     }
     return map;
  }
