...
class GetCharactersCharacterIdContracts200Ok {
  ...
  static List<GetCharactersCharacterIdContracts200Ok> listFromJson(List<dynamic> json) {
    return json == null ? List<GetCharactersCharacterIdContracts200Ok>() : json.map((value) => GetCharactersCharacterIdContracts200Ok.fromJson(value)).toList();
  }

  static Map<String, GetCharactersCharacterIdContracts200Ok> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GetCharactersCharacterIdContracts200Ok>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GetCharactersCharacterIdContracts200Ok.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetCharactersCharacterIdContracts200Ok-objects as value to a dart map
  static Map<String, List<GetCharactersCharacterIdContracts200Ok>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<GetCharactersCharacterIdContracts200Ok>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = GetCharactersCharacterIdContracts200Ok.listFromJson(value);
       });
     }
     return map;
  }
